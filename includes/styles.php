...
<style type="text/css" media="screen">
	...
	.noticias .item-noticia .noticia-img {
		height: 10em;
		...
		@media (max-width: 768px) {
			.atividades .midle-content #resultados .row1 .box-esq .col-xs-4 img {
			max-width: 100%;
			}
		.atividades .midle-content #resultados .row1 .box-dir .info {
			margin-top: 20px;
		}
		.atividades .midle-content #resultados .row2 .box-esq {
			padding-right: 15px;
		}
		.atividades .midle-content #resultados .row2 .box-esq .info {
			margin-top: 50px;
			margin-bottom: 10px;
		}

		.atividades .midle-content #resultados .row3 .box-dir .numero {
			clear: both;
			font-size: 75px;
			line-height: 25px;
		}
		.atividades .midle-content #resultados .row3 .box-dir .numero span {
			padding: 0 !important;
			font-size: 24px;
		}
		.atividades .midle-content #resultados .row3 .box-dir .info {
			margin-right: 80px;
		}
		.atividades .midle-content #resultados .row3 .box-esq .info span {
			display: block;
			padding-top: 5px;
		}
		.atividades .midle-content #resultados .row4 .box-esq {
			padding-right: 15px;
		}

		.atividades .midle-content #resultados .row6 .box-esq {
			padding-right: 15px;
		}
		.atividades .midle-content #resultados .row6 .box-esq::after {
			content: '';
			display: block;
			clear: both;
			height: 50px;
		...
		.noticias .slick li .img {
			display: none;
		}
		.noticias .slick li .caption {
			float: none;
			width: 100%;
		}
		.noticias .slick li .caption .txt {
			width: 100%;
			padding-right: 30px;
		}
		.noticias .slick .sy-controls {
			width: 100vw;
		}
		.noticias .button_li {
			/* display: none; */
		...
		.noticias .button_li button {
			margin-left: 0 !important; 
		}
		.noticias .midle-content {
			position: relative;
		}
		.noticias .midle-content .content {
			clear: both;
			margin-top: 0;
		}
		.noticias .midle-content .bg-top {
			width: 100%;
			overflow-x: hidden;
		}
		.noticias .midle-content .bg-top img {
			margin-top: 0;
			width: auto;
		}
		...
		.noticias .midle-content .content .btn-ler-noticia {
			margin-top: 0;
		}
		.noticias .btn-mais {
			width: 100%;
		...
		.noticias-interna .slider {
			width: 100vw !important;
			background: url('http://eletropaulonasescolas.com.br/assets/site/images/banner_noticias.png') center center !important;
			background-size: cover !important;
			height: 260px !important;
			overflow-y: hidden;
		}
		.noticias-interna .slider li {
			display: none;
		}
		.noticias-interna .midle-content .bg-top {
			margin-top: 0;
			height: 50px;
...
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Amatic+SC:400,700">
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Open+Sans+Condensed:300,300italic">
